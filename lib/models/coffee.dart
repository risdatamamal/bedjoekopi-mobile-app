...
List<Coffee> mockCoffees = [
  ...
  Coffee(
      ...
      name: "Cappucino",
      description: "Cappucino adalah minuman khas Italia yang dibuat dari espresso dan susu, tetapi referensi lain juga ada yang menyebutkan bahwa kapucino berawal dari biji biji kopi tentara Turki yang tertinggal setelah peperangan yang di pimpin oleh Kara Mustapha Pasha di Wina, Austria melawan tentara gabungan Polandia-Germania.",
      categories: "Espresso Based",
      price: 25000,
      rate: 3.8,
      types: [CoffeeType.espressoBased]),
  Coffee(
      id: 8,
      picturePath:
          "https://www.acouplecooks.com/wp-content/uploads/2020/10/How-to-make-a-latte-003.jpg",
      name: "Caffe Latte",
      description: "Caffè latte adalah espresso atau kopi yang dicampur dengan susu dan memiliki lapisan busa yang tipis di bagian atasnya. Perbandingan antara susu dengan kopi pada caffè latte adalah 2:1.",
      categories: "Espresso Based",
      price: 25000,
      rate: 4.5,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Macchiato",
      description: "macchiato adalah minuman kopi yang dibuat dengan mencampurkan espresso dengan susu. Ada dua jenis macchiato yang biasanya disajikan, yaitu espresso macchiato dan latte macchiato. Espresso macchiato dibuat dengan menambahkan sedikit susu ke dalam segelas espresso.",
      categories: "Espresso Based",
      price: 25000,
      rate: 4.0,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Long Black",
      description: "Long Black adalah salah satu jenis kopi yang umumnya tersedia di Australia dan Selandia Baru. Long Black mirip dengan Americano, tetapi memiliki aroma dan cita rasa yang lebih kuat. Secangkir long black dibuat dengan menuangkan dua seloki espreso atau ristreto ke atas air panas.",
      categories: "Espresso Based",
      price: 20000,
      rate: 3.0,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Espresso",
      description: "Espreso adalah minuman yang dihasilkan dengan mengekstraksi biji kopi yang sudah digiling dengan menyemburkan air panas di bawah tekanan tinggi. Espresso berasal dari Bahasa Italia yang berarti express atau 'cepat' karena dibuat untuk disajikan dengan segera kepada pelanggan.",
      categories: "Espresso Based",
      price: 20000,
      rate: 3.6,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Dalgona Coffee",
      description: "Dalgona adalah minuman yang dibuat dengan mencampurkan kopi instan, gula, dan air panas dengan jumlah perbandingan yang sama. Campuran itu kemudian dikocok sehingga menjadi krim dan kemudian ditambahkan ke susu dingin atau panas.",
      categories: "Espresso Based",
      price: 20000,
      rate: 4.0,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Avocado Coffee",
      description: "Avocado Coffee punya cita rasa yang berbeda dari jenis kopi lainnya. Pahitnya kopi berpadu dengan creamy-nya jus alpukat. Kopi alpukat ini semakin nikmat jika diminum dingin. Sering disajikan di berbagai coffee shop populer, kali ini buat sendiri saja.",
      categories: "Espresso Based",
      price: 20000,
      rate: 4.5,
      types: [CoffeeType.espressoBased]),
  ...
  Coffee(
      ...
      description: "Sajian kopi susu dingin yang menyegarkan cocok untuk dihidangkan di segala suasana.",
      categories: "Espresso Based",
      price: 20000,
      rate: 3.8,
      types: [CoffeeType.espressoBased]),
  Coffee(
      ...
      name: "Cafe Bonbon",
      description: "Cafe Bonbon atau yang biasa dikenal dengan cortado condensada. Cafe Bonbon adalah espresso yang dicampur dengan susu kental manis.",
      categories: "Espresso Based",
      price: 20000,
      rate: 3.9,
      types: [CoffeeType.espressoBased]),
  ...
  Coffee(
      ...
      name: "Nachos",
      description: "Nachos adalah makanan khas Mexico yang terbuat dari keripik Tortilla. Biasanya Nachos dimakan dengan keju cair diatasnya.",
      categories: "Snack",
      price: 20000,
      rate: 3.4,
      types: [CoffeeType.snack]),
  Coffee(
      ...
      name: "Risoles",
      description: "Risoles adalah makanan ringan yang cukup terkenal di Indonesia. Risoles berasal dari Bahasa Belanda yang artinya pastri isi daging. Risoles biasanya berisi daging cincang beserta sayuran yang dibungkus dengan dadar yang kemudian dilapisi dengan tepung panir serta kocokan telur.",
      categories: "Snack",
      price: 18000,
      rate: 3.6,
      types: [CoffeeType.snack]),
  Coffee(
      ...
      description: "Green tea latte, diracik dari tiga bahan dasar utama berupa powder green tea, ice, dan susu yang diproses mixing. Green tea latte (teh hijau latte) dan kopi Caramel Macchiato. Sedangkan rasanya, identik manis dan pahit khas green tea. Sesuai julukannya, minuman ini dominan dengan warna hijau yang cantik.",
      categories: "Non-Coffee",
      price: 20000,
      rate: 4.6,
      types: [CoffeeType.nonCoffee]),
  Coffee(
      id: 23,
      picturePath:
  ...
  Coffee(
      ...
      name: "Ice Red Velvet",
      description: "Rasa red velvetnya kerasa banget apalagi dengan toping es krim nikmatnya tiada tara",
      categories: "Non-Coffee",
      price: 20000,
      rate: 3.8,
      types: [CoffeeType.nonCoffee]),
  Coffee(
      ...
      name: "Ice Taro",
      description: "Rasa taro dengan serutan dark chocolate, taro apa sich taro itu dari tales ya gaess",
      categories: "Non-Coffee",
      price: 20000,
      rate: 4.9,
      types: [CoffeeType.nonCoffee]),
  Coffee(
      ...
      description: "Sebuah pers Perancis, juga dikenal sebagai cafetière, cafetière à piston, Caffettiera sebuah stantuffo, press pot, kopi pers, atau kopi plunger, adalah kopi perangkat pembuatan bir, meskipun juga dapat digunakan untuk tugas-tugas lainnya. Pada tahun 1923 Ugo Paolini, seorang Italia, mengajukan dokumen paten yang berkaitan dengan pemisah jus tomat dan ia mengembangkan ide membuat teko kopi dengan tindakan tekan dan filter. Ia menyerahkan patennya pada tahun 1928 kepada desainer Italia Attilio Calimani dan Giulio Moneta yang mengajukannya pada tahun 1929.",
      categories: "Tea",
      price: 15000,
      rate: 3.8,
      types: [CoffeeType.tea]),
  Coffee(
      id: 27,
      picturePath:
          "https://magfood-amazy.com/wp-content/uploads/2017/12/ice-lemon-tea.jpg",
      name: "Lemon Tea",
      description: "Lemon tea adalah minuman rendah kalori yang akan membantu Anda mengatur dan mengurangi jumlah kalori yang Anda konsumsi. Selain menurunkan berat badan, lemon tea mengandung phytochemical yang membantu kondisi tubuh dalam memerangi penyakit jantung, diabetes, kanker dan osteoporosis.",
      categories: "Tea",
      price: 18000,
      rate: 4.1,
      types: [CoffeeType.tea]),
